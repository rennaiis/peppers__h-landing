  ...
  return(
    <footer className={styles.footer}>
        ...
        <div className={styles.footer__content}>
          <Icon className={classNames(styles.footer__logo, styles.footer__logo_mob)} name={social.logo}/>
          <div className={styles.footer__socials}>
            <div className={styles.footer__caption}>{safeHTML(social.caption)}</div>
            <Icon className={classNames(styles.footer__logo, styles.footer__logo_desktop)} name={social.logo}/>
