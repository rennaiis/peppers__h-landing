...
export const video = {
  ...
  videoSrc: 'images/video/videoExample.mp4',
  videoPreviewSimple: image("video/videoPreview.png"),
  videoPreview: {
    sourceData: {
      sources: [
        {
  ...
  social: {
    ...
    links: [
      ...
      },
      {
        tag: 'a',
        target: '_blank',
        href: 'https://t.me/s/aboutstoloto', 
        icon: 'tg', 
        className: 'customButton_soc'
      },
    ]
...
export const mapModal = {
  ...
  caption: 'Найди ближайший магазин «Столото»', 
  mapPic: {
    sourceData: {
      sources: [
        {
          srcSet: `${image("map/map-m.webp")} 1x, ${image("map/map-m@2x.webp")} 2x`, 
          media: `(max-width: ${NOT_MOB - 1}px)`,
          type:"image/webp"
        },
        {
          srcSet: `${image("map/map-m.jpg")} 1x, ${image("map/map-m@2x.jpg")} 2x`, 
          media: `(max-width: ${NOT_MOB - 1}px)`
        },
        {
          srcSet: image("map/map.webp"),
          type:"image/webp"
        },
      ]
    },
    imgAttr: {
      src: image("map/map.jpg"),
    }
  },
  addresses: [
    { address: "Пермский край, Пермь г, Адмирала Ушакова ул, 55" },
    { address: "Пермский край, Пермь г, Архитектора Свиязева ул, 30" },
    { address: "Пермский край, Пермь г, Белинского ул, 47" },
    { address: "Пермский край, Пермь г, Адмирала Ушакова ул, 55" },
    { address: "Пермский край, Пермь г, Архитектора Свиязева ул, 30" },
    { address: "Пермский край, Пермь г, Белинского ул, 47" },
    { address: "Пермский край, Пермь г, Вильямса ул, 49а" },
    { address: "Пермский край, Пермь г, Героев Хасана ул, 105, а" },
    { address: "Пермский край, Пермь г, Ивана Франко ул, 38" },
    { address: "Пермский край, Пермь г, Крупской ул, 42" },
    { address: "Пермский край, Пермь г, Куйбышева ул, 36" },
    { address: "Пермский край, Пермь г, Ласьвинская ул, 37, 1" },
    { address: "Пермский край, Пермь г, Ленина ул, 76" },
    { address: "Пермский край, Пермь г, Ленина ул, 76" },
    { address: "Пермский край, Пермь г, Ленина ул, 76" }
  ], 
